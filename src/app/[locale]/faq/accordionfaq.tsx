              ...
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="p-4 leading-6 font-display tracking-wide text-sm text-black">
                    {i == 2 ? (
                      <>
                        {response} <a className='text-ciel' href="https://docs.google.com/forms/d/1xwNc8N-Lb8lGoP-JNDg_u-yfRyrizFD7P5CPHqaQ9Ck/viewform?ts=65bb3617&edit_requested=true" target="_blank" rel="noopener noreferrer" >{t('faq-link')}.</a>
                      </>
                    ) : response}
                  </Disclosure.Panel>
                </>
